...
<!--  	<div id="otherSlots">
	...
	<div id="content">		
		...
		<img style="width: 100px; position: fixed; display: block; margin: auto; right: 0px; margin-top: 43vh;" src="style/images/icons/full-screen-38-48.png" alt="ToggleFullscreen" id="fullScreenButton" onclick="toggleFullscreen();">
...
<!-- 		<p id="responseDebug"></p>
	...
	<script>
		...
		function sendData()
		{
/* 			let playersNumberCreated;
			let playersNumberInstallation;
			readPlayersNum('php/data/players_created_counter.data')
				.then(dataText => {
					playersNumberCreated = dataText;
			});
			
			readPlayersNum('php/data/installation_form_app.data')
				.then(dataText => {
					playersNumberInstallation = dataText;
			}); */
...
/*  														let xmlhttpRoundDataReset = new XMLHttpRequest();
														xmlhttpRoundDataReset.onreadystatechange = function(){
															if (xmlhttpRoundDataReset.readyState == XMLHttpRequest.DONE) {
																if (xmlhttpRoundDataReset.status == 200) {

																}else if (xmlhttpRoundDataReset.status == 400) {
																	alert('There was an error 400');
																}else {
																	alert('something else other than 200 was returned');
																}
														...
														xmlhttpRoundDataReset.open("GET", "php/round_data.php?data=reset", true);
														xmlhttpRoundDataReset.send(); */
